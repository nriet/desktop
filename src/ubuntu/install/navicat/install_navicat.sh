...
cp /dockerstartup/install/navicat/navicat.desktop /usr/share/applications/navicat.desktop
mkdir /opt/Navicat15
cp /dockerstartup/install/navicat/navicat.png /opt/Navicat15/navicat.png
